...
{
    system("clear");
    cout << "//PERIOD UPDATE MENU//" << endl;
    Per per;
    per.id = id;
    cout << "Enter new name: ";
    cin >> per.name;
    cout << "Enter new timespan: ";
    string length;
    cin >> length;
...
{
    system("clear");
    cout << "//PERIOD CREATION MENU//" << endl;
    Per per;
    cout << "Enter name: ";
    cin >> per.name;
    cout << "Enter timespan: ";
