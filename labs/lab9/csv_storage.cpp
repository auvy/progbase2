...
vector<Dino> CsvStorage::getAllUserDino(int user_id)
{
    vector<Dino> dinos;
    Dino d;
    d.id = 0;
...
vector<Per> CsvStorage::getAllDinoPer(int dino_id)
{
    vector<Per> pers;
    Per p;
    p.id = 0;
...
bool CsvStorage::insertDinoPer(int dino_id, int per_id)
{
    return false;
}


bool CsvStorage::removeDinoPer(int dino_id, int per_id)
{
    return false;
}
